...
namespace BookStoreApp.Controllers
{
    public class PrintersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Brand")] Printer printer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Brand")] Printer printer)
        {
            if (id != printer.Id)
            {
                return NotFound();
